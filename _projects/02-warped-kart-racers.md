...
{% include youtube.html id="hllItU128ho?si=KufremwUBgxVxVlB" %}

## Key Contributions

- Led live-ops design across five major updates, analyzing retention and engagement data to inform feature direction.  
- Designed and feature-championed three new game modes: **Elimination**, **Crowned**, and **Overcharged**.  
- Designed League and Arcade systems, including progression logic, difficulty balancing, and rewards.  
- Created and maintained documentation in Confluence covering design, analysis, and playtest feedback.  
